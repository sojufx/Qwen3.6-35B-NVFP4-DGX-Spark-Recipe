...
magick -size 1600x900 xc:'#070b12' \
  ...
  -stroke none -font "$FONT" -fill '#94a3b8' -pointsize 29 -annotate +94+184 'Native vLLM 0.27 · 262K context · FP8 KV · RedHat DSpark K=8 · marlin MoE' \
  \
  ...
  -stroke none -font "$BOLD" -fill '#f8fafc' -pointsize 58 -annotate +122+320 '114.6' \
  ...
  -stroke none -font "$BOLD" -fill '#f8fafc' -pointsize 58 -annotate +552+320 '417.8' \
  ...
  \
  -stroke none -font "$BOLD" -fill '#f8fafc' -pointsize 38 -annotate +98+415 'Fixed decode benchmark' \
  -stroke none -font "$FONT" -fill '#94a3b8' -pointsize 24 -annotate +98+453 '256-token code-edit generations · OpenAI-compatible endpoint' \
  \
  ...
  -stroke none -font "$BOLD" -fill '#f8fafc' -pointsize 27 -annotate +221+650 '114.6' \
  ...
  -stroke none -font "$BOLD" -fill '#f8fafc' -pointsize 27 -annotate +450+587 '197.0' \
  ...
  -stroke none -font "$BOLD" -fill '#f8fafc' -pointsize 27 -annotate +690+509 '287.7' \
  ...
  -stroke none -font "$BOLD" -fill '#f8fafc' -pointsize 27 -annotate +930+433 '366.1' \
  ...
  -stroke none -font "$BOLD" -fill '#f8fafc' -pointsize 27 -annotate +1170+423 '417.8' \
  ...
  -stroke none -font "$FONT" -fill '#94a3b8' -pointsize 21 -annotate +1390+500 'runtime' \
  -stroke none -font "$BOLD" -fill '#f8fafc' -pointsize 31 -annotate +1390+545 '12 GiB' \
  -stroke none -font "$FONT" -fill '#94a3b8' -pointsize 19 -annotate +1390+582 'fp8 KV' \
  -stroke none -font "$FONT" -fill '#94a3b8' -pointsize 21 -annotate +1390+650 'critical' \
  -stroke none -font "$BOLD" -fill '#f8fafc' -pointsize 27 -annotate +1390+692 'marlin MoE' \
  \
